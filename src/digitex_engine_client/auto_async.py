...
background_event_loop_semaphore = threading.Semaphore(0)
...
def get_or_create_background_event_loop():
    def background_thread():
        ...
        background_event_loop_semaphore.release()
    ...
    with background_event_loop_lock:
        ...
        background_event_loop_semaphore.acquire()
        return background_event_loop
...
def synchonized(f):
    ...
    async def wrapper(self, *args, **kwargs):
        ...
        # not racy, becuase there are no await points
        # here.
